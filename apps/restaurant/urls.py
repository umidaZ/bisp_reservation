...
restaurant_router.register('reviews', views.MenuCategoryViewSet, basename='restaurant-reviews')
restaurant_router.register('menu_categories', views.ReviewViewSet, basename='restaurant-manu_categories')
